...
import { apiUpdateProduct, apiCreateProduct,apiImportProduct } from "../apis/product";

const InsertProduct = ({ product, setIsEdit, setIsCreate , isImport=false }) => {
...
const [detailOne, setDetailOne] = useState({
  ...
  return (
    <div className="flex flex-col items-center pb-[100px]">
      ...
      {  !isImport && <div className="flex gap-4 py-4">
        ...
        {  !isImport && <div className='flex flex-col gap-2 border-t py-4'>
